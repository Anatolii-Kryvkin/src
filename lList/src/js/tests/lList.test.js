...
describe('addEnd', function () {
    it('size AddEnd', function () {
        let arrayAddEnd = new Llist([8, 10, 4, 2, 26, 25]);
        arrayAddEnd.clear();
...
describe('delStart', function () {
    it('Returns the first element', function () {
        let arrayDelStart = new Llist([8, 10, 4, 2, 26, 25]);
...
describe('delEnd', function () {
    it('Returns the last element', function () {
        let arrayDelEnd = new Llist([8, 10, 4, 2, 26, 25]);
        arrayDelEnd.delEnd();
...
describe('delPos', function () {
    it('Returns position element', function () {
        let arrayDelPos = new Llist([8, 10, 4, 2, 26, 25]);
        arrayDelPos.delPos(2);
        assert.deepEqual(arrayDelPos.size(), 5)
    })
});
describe('get', function () {
    it('Get elements', function () {
        let arrayGet = new Llist([8, 10, 4, 2, 26, 25]);
        arrayGet.get(3);
...
describe('set', function () {
    it('Set elements', function () {
        ...
        arraySet.set(5, 3);
        assert.deepEqual(arraySet.size(), 7)
    })
});
describe('toString', function () {
    it('String arrays', function () {
        let arrayToString = new Llist([8, 10, 4, 2, 26, 25]);
        arrayToString.toString ();
        assert.deepEqual(arrayToString.size(), 6)
    })
}); 
...
describe('clear', function () {
    it('Return array', function () {
        let arrayClear = new Llist([8, 10, 4, 2, 26, 25]);
        arrayClear.clear();
...
describe('max', function () {
    it('Return min element', function () {
        let arrayMax = new Llist([8, 10, 4, 2, 26, 25]);
            arrayMax.max();
...
describe('sort', function () {
    it('Return  sort elements', function () {
        let arraySort = new Llist([8, 10, 4, 2, 26, 25]);
            arraySort.sort();
            assert.deepEqual(arraySort.toString(), '248102526')
    })
});
describe('maxIndex', function () {
    it('Return index max element', function () {
        let arrayMaxIndex = new Llist([8, 10, 4, 2, 26, 25]);
...
describe('minIndex', function () {
    it('Return index min element', function () {
        let arrayMinIndex = new Llist([8, 10, 4, 2, 26, 25]);
...
describe('reverse', function () {
    it('Reverse elements', function () {
        let arrayReverse = new Llist([8, 10, 4, 2, 26, 25]);
...
describe('halfReverse', function () {
    it('HalfReverse elements', function () {
        let arrayHalfReverse = new Llist([8, 10, 4, 2, 26, 25]);
...
describe('addPos', function () {
    it('Add position elements', function () {
        let arrayAddPos = new Llist([8, 10, 4, 2, 26, 25]);
